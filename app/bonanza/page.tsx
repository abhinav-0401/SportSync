...
export default function Bonanza() {
  return (
    <div className="bg-[#E6E6DD] px-20 py-16 gap-20 flex flex-col">
      <header className="flex flex-col items-center text-4xl font-bold">
        <h1>FESTIVE BONANZA</h1>
      </header>
      ...
      <div className="flex justify-between">
        ...
        <div className="flex-1 h-full">
          <Image src="/intro-football.png" className="h-full w-auto" alt="intro football" width={946} height={654} />
        </div>

        {/* intro text + buttons */}
        <div className="flex-1 flex flex-col gap-20">
          <div className="font-normal text-lg text-[#45474A]">
          ...
          <div className="flex gap-20">
            <Button variant={"secondary"} className="italic">Click here to know more</Button>
        ...
        <div className="flex flex-col gap-10">
          ...
          <div className="flex justify-between">
            <Image src="/prizes-1.png" alt="win prize 600" height={343} width={330} />
        ...
        <div className="flex flex-col gap-10">
          ...
          <div className="flex justify-between gap-6">
            ...
            <div className="flex-1 flex flex-col justify-between items-center">
              <h1 className="text-4xl font-bold">CONFUSED?!</h1>
              <div className="text-xl text-wrap text-[#45474A] text-center font-normal">
                Want us to surprise for you? “Lorem ipsum dolor sit amet, consectetur adipiscing elit. Turpis donec amet proin
              </div>
              <Button className="italic">Click here to get a surprise</Button>
            </div>
          </div>
        </div>
