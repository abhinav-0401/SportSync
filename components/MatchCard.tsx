...
export default function MatchCard() {
  return (
    <div className="flex flex-col gap-4 rounded-xl bg-white/40 py-7 px-12">
      
      <div className="flex justify-between">
        <h3 className="font-bold text-lg">Indian Premier League</h3>
        ...
        <div className="flex items-center gap-8">
          ...
          <div className="flex flex-col gap-4 justify-between">
            ...
            <div className="flex gap-4 justify-between">
              ...
              <div className="font-semibold text-base text-[#45474A]">ENG</div>
            </div>
          </div>
        </div>
