  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <div className="flex items-center gap-4 md:gap-8">
        <Image src="/analytics-summary.png" alt="summary" className="max-w-[150px]" height={177} width={182} />

        <div className="flex flex-col gap-2 sm:gap-4 md:gap-8">
          <h3 className="font-semibold text-lg md:text-xl lg:text-2xl">England premier league.a..,swqdiwd</h3>
          <div className="font-normal text-base md:text-lg lg:text-xl text-[#45474A]">
