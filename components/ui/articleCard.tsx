...
const ArticleCard: React.FC<ArticleCardProps> = ({ title, description, date, imageUrl }) => {
    return (
        <div className="flex max-h-[450px] flex-col md:flex-row items-center gap-5 p-5 hover:bg-[#45474a80] cursor-pointer bg-white/66 rounded-xl border border-solid border-gray-300/66 shadow-lg">
