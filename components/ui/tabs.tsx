  ...
  "inline-flex items-center justify-center",
  {
    variants: {
      variant: {
        ...
        outline: "px-3 py-1.5 text-sm font-medium ring-offset-background transition-all data-[state=active]:border-b-2 dark:data-[state=active]:border-white data-[state=active]:border-black data-[state=active]:text-foreground text-muted-foreground",
        // Add more variants here
      },
    },
    defaultVariants: {
